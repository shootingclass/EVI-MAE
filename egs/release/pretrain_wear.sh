...
dataset=wear
dataset_base_path=/home/junho/Multimodal/ECCV/data_release/wear-release
...
pretrain_path=/home/junho/Multimodal/ECCV/data_release/videomae_adapt_ckpt/pretrain-wear/models/best_evi_model.pth
...
# src/run_evimae_pretrain.py 파일에서부터 시작
CUDA_VISIBLE_DEVICES="0, 1, 2, 3" CUDA_CACHE_DISABLE=1 python -W ignore ../../src/run_evimae_pretrain.py --model ${model} --dataset ${dataset} \
