...
dataset=opp
dataset_base_path=/mnt/hdd4tb/junho/Opportunity++
data_train=${dataset_base_path}/data_processed/cav_label/train_pretrain/train_pretrain.json
data_val=${dataset_base_path}/data_processed/cav_label/test_pretrain/test_pretrain.json
label_csv=${dataset_base_path}/data_processed/cav_label/class_labels_indices.csv

pretrain_path=/home/junho/ECCV/data_release/videomae_adapt_ckpt/video_imu_beforepretrain_model_small_only_encoder.pth
